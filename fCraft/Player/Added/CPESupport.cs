...
namespace fCraft
{
    ...
    public sealed class CpeExtension
    {
        ...
        public static void LoadDisabledList()
        {
            ...
            PropertiesFile.Read(Paths2.CPEDisabledFile, ParseLine, '=');
            ...
            {
                Logger.Log(LogType.Error,"Error saving CPE disabled list");
            }
        }
        ...
        {
            using (StreamWriter w = new StreamWriter(Paths2.CPEDisabledFile))
            {
