...
namespace fCraft {
    ...
    public enum ConfigKey {
        ...
        [StringKey( ConfigSection.General, "Custom ClassiCube Server (fCraft)",
...
overwhelming the Internet connection with data.",
        ...
        [StringKey( ConfigSection.General, "https://classicube.net/heartbeat.jsp",
...
@"Whether to prepend rank prefixes to players with a custom DisplayedName set." )]
        ...
        [BoolKey( ConfigSection.Chat, false,
@"Show prefixes in the player list. As a side-effect, classicube client
...
Otherwise, only chat messages starting with a hash (#) will be relayed." )]
        ...
        [BoolKey( ConfigSection.IRC, false,
@"Show a message on IRC when someone joins or leaves the classicube server." )]
